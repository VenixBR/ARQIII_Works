...
#-----------------------------------------------------------------------------
set_db init_hdl_search_path "${DEV_DIR} ${FRONTEND_DIR} ${HDL_DIR}/Described_HDLs ${HDL_DIR}/Provided_HDLs"
...
read_hdl -language v2001 ${HDL_DIR}/Comparator.v
read_hdl -language v2001 ${HDL_DIR}/ControlPath.v
read_hdl -language v2001 ${HDL_DIR}/DataPath.v
read_hdl -language v2001 ${HDL_DIR}/BubbleSort.v
